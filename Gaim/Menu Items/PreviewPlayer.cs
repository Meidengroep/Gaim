...
namespace Gaim
{
    ...
    {
        public PreviewPlayer(Vector2 position, bool newGame, bool knalluh)
            : base(position, newGame, knalluh)
        {
            engineBar = new VerticalBar(Global.Game.Content.Load<Texture2D>("Overlays/Enginebar"), new Vector2(600, 520), this.engine);
            schieten = new PreviewSchieten(newGame, knalluh);
            Global.Player = this;
        }

        protected VerticalBar engineBar;
        protected new PreviewSchieten schieten;
        ...
        public override void Update(GameTime gt)
        {
            ...
            schieten.Update(position + new Vector2(currentTexture.Width / 2, 0), gt, knalluh, this);
