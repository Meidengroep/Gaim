...
namespace Gaim
{
    ...
    {
        public TardBoss(Texture2D sprite, Vector2 position, Texture2D bulletSprite, Texture2D ballBulletSprite)
            : base(sprite, position)
        {
            ...
            this.healthBar = new HorizontalBar(Global.Game.Content.Load<Texture2D>("Overlays/BossHealthBar"), new Vector2(100, 10), this.health);
    ...
    {
        public TardEnemy(Texture2D sprite, Vector2 position)
            : base(sprite, position)
        {
    ...
    {
        public ShootingTard(Texture2D sprite, Texture2D bulletSprite, Vector2 position)
            : base(sprite, position)
        {
    ...
    {
        public TargetPracticeEnemy(Texture2D sprite, Vector2 position)
            : base(sprite, position)
        {
    ...
    {
        public FromLeftAimingEnemy(Texture2D sprite, Vector2 position)
            : base(sprite, position)
        {
    ...
    {
        public FromRightAimingEnemy(Texture2D sprite, Vector2 position)
            : base(sprite, position)
        {
            this.velocity = new Vector2(-5, -1);
            this.health = 50;
